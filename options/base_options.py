...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # 模型保存路径修改default='unet'
        self.parser.add_argument('--name', type=str, default='global', help='name of the experiment. It decides where to store samples and models')        
        ...
        # for setting inputs# 输入数据集路径
        self.parser.add_argument('--dataroot', type=str, default='./datasets/Incomplet-mural-data/test') 
